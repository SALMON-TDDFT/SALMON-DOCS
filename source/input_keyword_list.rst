...
real(8), default=0d0
   ...
   | For a slab system, ``film_thickness`` should be set to the side length of the calculation cell [the thickness of the slab plus the length of the vacuum region, Yamada et al., PRB 98, 245147 (2018)].
